...
public class Server extends Thread implements Closeable {
    ...
    public void run() {
        ...
        while (running) {
            ...
            try {
                ...
                System.out.println("DEBUG: Raw message received: " + received);
    ...
    private void handleHello(SocketAddress clientAddr, InetAddress address, int port, String nickname) throws IOException {
        ...
        var joinMsg = new Message(nickname + " joined the chat.", "Server", Message.Type.JOIN);
    ...
    private void handleMessage(SocketAddress clientAddr, Message message) throws IOException {
        ...
        var finalMessage = new Message(message.getContent(), nickname, message.getTimestampEpoch(), message.getType());
